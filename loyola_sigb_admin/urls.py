from opac.views import OpacInstitucionAutocomplete, OpacDescriptorAutocomplete, OpacAutorAutocomplete,OpacTesisAutorAutocomplete, OpacAutor2Autocomplete, OpacAutor3Autocomplete, OpacEditorialAutocomplete, OpacColeccionAutocomplete, OpacUsuarioAutocomplete,OpacMateriasAutocomplete, OpacCiudadAutocomplete, OpacCatedraAutocomplete
...
from novedades_bibliograficas.views  import BoletinesViewSet
