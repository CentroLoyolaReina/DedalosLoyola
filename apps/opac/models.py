...
class OpacLibro(models.Model):
    ...
    numero_ejemplares = models.PositiveIntegerField(default=0,blank=True,null=True)
    numero_ejemplares_prestados = models.PositiveIntegerField(default=0,blank=True,null=True)
